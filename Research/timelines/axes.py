  ...
  "changelog": [
    ...
    {"version": REGISTRY_VERSION, "date": "2026-08-20",
     "change": "r8b - the argmax stops enumerating, and the test that would "
               ...
               "is 102 minutes a call. That extrapolation has since been "
               "replaced by a wall-clock reading: a second session timed "
               "exemplars(k=5) - one mainline call plus five trivial "
               "world-lines - at 5,706 seconds, so the figure is 95.1 minutes "
               "a call and the emit makes two, 3.2 hours. The same probe timed "
               "bands at 0.02s, which rules the rest of the emit out rather "
               "than merely leaving it unaccused. The run was stopped twice "
